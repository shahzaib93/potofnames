...
const myarr = [{"one":1},{"two":2},{"three":3},{"four":4},{"five":5}]
            ...
            <div className="container-fluid">
              ...
              <div style={{marginLeft:"10%"}} className="d-flex">
                <div className="navbar-nav">
                  ...
                  {/* {!enableFullScreen?} */}
                  <button hidden={enableFullScreen} type="button" className="active px-4 nav-link btn btn-link" onClick={()=>router.push("/settings")}>
                  SETTINGS
                    </button>
                  ...
                  {
                    (session ? 
                    <button hidden={enableFullScreen}  className="nav-link px-4 btn btn-link" type="button" onClick={() => signOut()}>LOGOUT</button> :
                    <button hidden={enableFullScreen} type="button" className="px-4 nav-link btn btn-link" data-bs-toggle="modal" data-bs-target="#loginModal">
                      LOGIN
                    </button>
                    )
                  }
...
{gameType == 'pot' &&
              <button hidden={!enableFullScreen} onClick={shakeBtn} type="button" className="active px-4 nav-link btn btn-link" >
              SHAKE
                </button>
            }
            {gameType == 'wheel' &&
              <button hidden={!enableFullScreen} onClick={() => settheShouldWeSpin(true)} type="button" className="active px-4 nav-link btn btn-link" >
              SPIN
                </button>
            }
...
<button type="button" className="px-4 nav-link btn btn-link" onClick={()=>setenableFullScreen(!enableFullScreen)}>
                      Full Screen
                    </button>
...
style={customStyles}
      ...
      >
        ...
        <form style={{display:showdivs}} style={{marginLeft:"5%"}} className="row justify-content-center mt-3" method="post" onSubmit={addParticipant}>
